...
COPY public.orders ("orderId", "cartId", "firstName", "lastName", address, address2, zipcode, city, state, phone, "cardSecurityCode", "cardExpMonth", "cardExpYear", "createdAt") FROM stdin;
\.
